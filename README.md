...
<!-- Please read the https://github.com/linuxserver/docker-openvscode-server/blob/insiders/.github/CONTRIBUTING.md -->
...
* Update the image: `docker pull lscr.io/linuxserver/openvscode-server:insiders`
